...
const HomeEstates = () => {
  ...
  return (
    <div className="bg-[#F4EDE8] pt-24 lg:pt-32 pb-16 md:pb-28 mt-32">
      {/* container */}
      <div className="w-[90%] md:w-[95%] mx-auto">
        ...
        {/* cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8  lg:gap-14 mt-10 lg:mt-20">
            {
